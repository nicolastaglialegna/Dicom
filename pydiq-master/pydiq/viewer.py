...
class Viewer(QtWidgets.QMainWindow):
    def __init__(self, path = None):
        ...
        self.setWindowTitle("Visualizador de imagenes medicas")
        self.file = None
       ...
       # self.series_dock = QtWidgets.QDockWidget("Información", self)
        #self.addDockWidget(QtCore.Qt.LeftDockWidgetArea, self.series_dock)
        #self.series_dock.

        self.file_dock = QtWidgets.QDockWidget("Imagenes", self)
    ...
    def export_image(self):
        ...
        file_name2, _ = QtWidgets.QFileDialog.getSaveFileName(self, "Guardar datos", os.path.expanduser("~/dicom-export.txt"), '.txt')
    ...
    def build_menu(self): 
        ...
        self.file_menu.addAction('&Abrir archivos', self.open_directory, QtCore.Qt.CTRL + QtCore.Qt.Key_O)
        self.file_menu.addAction('&Exportar datos', self.export_image, QtCore.Qt.CTRL + QtCore.Qt.Key_S)
        self.file_menu.addAction('&Salir', self.close, QtCore.Qt.CTRL + QtCore.Qt.Key_Q)     
        
        

        self.view_menu = QtWidgets.QMenu('&Ver', self)
        self.view_menu.addAction('Aumentar zoom', self.pix_label.increase_zoom, QtCore.Qt.CTRL + QtCore.Qt.Key_Plus)
        self.view_menu.addAction('Disminuir zoom', self.pix_label.decrease_zoom, QtCore.Qt.CTRL + QtCore.Qt.Key_Minus)
        ...
        self.tools_menu.addAction('&Ver información paciente', self.show_structure, QtCore.Qt.Key_F2)
    ...
    def show_structure(self):
        if self.file_name:
            ...
            #file_name, _ = QtWidgets.QFileDialog.getSaveFileName(self, "Save File", '/', '.txt')
